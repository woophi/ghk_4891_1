...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '4891_confirm_var1');
    setLoading(true);
  ...
  const openCalc = () => {
    window.gtag('event', '4891_calc_var1');
    setOpenBs(true);
  };
    ...
    <>
      <div className={appSt.container}>
        ...
        <div>
          ...
          <Typography.Text view="primary-medium">
            Программа долгосрочных сбережений (ПДС) — это как большая копилка, например, на учёбу или большую покупку.
            Государство помогает, добавляя дополнительные суммы.
          </Typography.Text>
        </div>
          ...
          <span>
            ...
            <Typography.Text
              ...
              onClick={() => {
                ...
                window.location.replace('alfabank://longread?endpoint=v1/adviser/longreads/48905');
              }}
              style={{
                color: '#2A77EF',
                cursor: 'pointer',
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ1_var1');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ2_var1');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ3_var1');
        ...
        <div style={{ marginTop: '1rem' }}>
          <div
            onClick={() => {
              window.gtag('event', '4891_FAQ4_var1');
        ...
        <div
          onClick={() => {
            window.gtag('event', '4891_moreinfo_var1');
